...
// В строчку всё будет, ибо 'a' не станет числом и заставит остальные значения оставаться простым текстом. Ееееее, я правильно мыслил. Logic)))))))
